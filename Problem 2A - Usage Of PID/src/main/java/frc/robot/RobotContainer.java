...
public class RobotContainer {
  ...
  private void configureBindings() {
    raiseButton.whenPressed(new RaiseElevatorCommand(elevatorSubsystem, 50));

    // Lower the elevator to 20 inches
    lowerButton.whenPressed(new LowerElevatorCommand(elevatorSubsystem, 0));
  }
